// FAQ content — shared by the /faq page (client render) and the /faq layout
// (server-side FAQPage JSON-LD), so the visible answers and the structured
// data can never drift apart. Content moved verbatim from faq/page.tsx.
