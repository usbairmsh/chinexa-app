            ...
            <div className="flex items-center gap-2">
              ...
              {product.stock_quantity > 0 && (
                <button
                  ...
                  className="flex h-9 items-center gap-1.5 px-4 rounded-full bg-secondary font-body text-[12px] font-semibold tracking-wide hover:bg-secondary-dark hover:shadow-[0_6px_30px_rgba(122,79,160,0.4)] hover:-translate-y-[1px] active:scale-[0.96] transition-all duration-300 !text-white"
                >
