    ...
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className={cn(
          ...
          open ? "bg-card shadow-[inset_0_0_0_1.5px_var(--color-secondary)]" : "bg-beige-dark/70 shadow-[inset_0_0_0_1px_rgba(58,36,56,0.06)] hover:bg-beige-dark",
      ...
      {open && (
        <div className="absolute z-50 mt-1.5 w-full rounded-luxury border border-border/50 bg-card shadow-luxury-hover overflow-hidden animate-scale-in">
