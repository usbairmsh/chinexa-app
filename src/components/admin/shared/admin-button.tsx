    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Variants
          variant === "primary" && "bg-secondary !text-white hover:bg-secondary-dark hover:!text-white hover:shadow-[0_6px_30px_rgba(192,57,43,0.4)] hover:-translate-y-[1px]",
          variant === "outline" && "border-2 border-secondary/30 bg-white !text-secondary hover:bg-secondary hover:!text-white hover:border-secondary hover:shadow-[0_6px_25px_rgba(192,57,43,0.25)] hover:-translate-y-[1px]",
