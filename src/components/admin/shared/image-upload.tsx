        ...
        <div className="space-y-2">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="h-10 px-4 rounded-full bg-charcoal text-white text-[12px] font-body font-semibold tracking-wide hover:bg-secondary hover:shadow-[0_4px_20px_rgba(192,57,43,0.3)] active:scale-[0.97] transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Apply
            </button>
          </div>
