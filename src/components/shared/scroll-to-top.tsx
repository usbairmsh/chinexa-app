    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 group flex h-11 w-11 items-center justify-center rounded-xl bg-card border border-border/40 text-charcoal shadow-[0_4px_24px_rgba(0,0,0,0.1)] hover:bg-charcoal hover:!text-white hover:border-charcoal hover:shadow-[0_6px_30px_rgba(0,0,0,0.2)] transition-all duration-300 cursor-pointer"
