...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background shadow-luxury-hover transition-transform duration-300 ease-out",
  {
    variants: {
      side: {
...
const SheetFooter = ({
  ...
  <div
    className={cn("mt-auto border-t border-border/50 p-6", className)}
    {...props}
  />
);
