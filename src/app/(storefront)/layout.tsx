    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center px-6 max-w-lg">
          <Image src="/logo.png" alt="ChineXa" width={400} height={152} className="h-[120px] w-auto mx-auto mb-8" />
          ...
          <p className="text-charcoal-lighter text-lg mb-6">
            We&apos;re performing scheduled maintenance to improve your shopping experience. Please check back shortly.
          </p>
          <div className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-pearl text-sm text-charcoal-lighter">
