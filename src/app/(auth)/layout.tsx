...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-luxury-gradient px-4 py-12">
      <Link href="/" className="mb-8">
        <Image src="/logo.png" alt="ChineXa" width={480} height={186} className="h-[192px] w-auto" />
      </Link>
