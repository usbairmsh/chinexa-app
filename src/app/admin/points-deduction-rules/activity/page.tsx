...
import {
  ArrowLeft, ChevronRight, Loader2, AlertTriangle, Undo2, Gift, X, Check,
} from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-charcoal-lighter mt-1">
            Every rule that has run automatically or manually. Click a row to see which customers matched, why, and to cancel or disburse points.
          </p>
        </div>
      </div>
